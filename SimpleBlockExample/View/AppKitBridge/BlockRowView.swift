...
private extension BlockRowView {
	func setUpViews() {
		...
		gutterWidthConstraint = gutterView.widthAnchor.constraint(equalToConstant: style.gutterSize.width)
		textLeadingConstraint = container.leadingAnchor.constraint(equalTo: gutterView.trailingAnchor, constant: style.gutterSpacing)
	...
	func updateLayout(for style: EditorStyle) {
